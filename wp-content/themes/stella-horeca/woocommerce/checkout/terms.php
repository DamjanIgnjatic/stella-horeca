...
if (apply_filters('woocommerce_checkout_show_terms', true) && function_exists('wc_terms_and_conditions_checkbox_enabled')) {
  ...
  echo startertheme_wc_get_corrected_terms(startertheme_wc_capture_hook_output('woocommerce_checkout_before_terms_and_conditions'));
?>
  <div class="woocommerce-terms-and-conditions-wrapper">
    ...
    echo startertheme_wc_get_corrected_terms(startertheme_wc_capture_hook_output('woocommerce_checkout_terms_and_conditions'));
    ?>
...
<?php
  echo startertheme_wc_get_corrected_terms(startertheme_wc_capture_hook_output('woocommerce_checkout_after_terms_and_conditions'));
}
