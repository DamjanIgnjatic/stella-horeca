...
function startertheme_product_page_ajax_add_to_cart_js() {
  ?>
  <script>
    jQuery(function ($) {
...
add_action('wp_footer', 'startertheme_product_page_ajax_add_to_cart_js');
// JS for AJAX Add to Cart handling End


// Add to cart handler
function startertheme_ajax_add_to_cart_handler() {
  WC_Form_Handler::add_to_cart_action();
  WC_AJAX::get_refreshed_fragments();
}

add_action('wc_ajax_ace_add_to_cart', 'startertheme_ajax_add_to_cart_handler');
add_action('wc_ajax_nopriv_ace_add_to_cart', 'startertheme_ajax_add_to_cart_handler');
...
function startertheme_ajax_add_to_cart_add_fragments($fragments) {
...
add_filter('woocommerce_add_to_cart_fragments', 'startertheme_ajax_add_to_cart_add_fragments');
