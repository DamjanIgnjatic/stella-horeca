  ...
  return gulp
    ...
    .pipe(
      esbuild({
        ...
        platform: "browser",
        target: ["es2018"],
        format: "iife", // self-executing, no <script type="module"> needed
        sourcemap: true,
        minify: true,
        // If you rely on WP-provided globals (don't bundle them):
...
// Default task
gulp.task("default", gulp.series("sass", "es6", "block-sass", "block-es6"));

// libraries
gulp.task("libraries", gulp.series("libraries-js", "libraries-css"));
