...
Replace all of the "StellaHoreca" string with your websites name and the "stellahoreca" string with your lowercased websites name without any whitespace (fore example instead of the string "The Theme" use "thetheme").
